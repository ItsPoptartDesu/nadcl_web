...
<select name="nadcl_siggy" class="form-select form-select-sm" aria-label=".form-select-sm example" >
    ...
    <option value="Death Profet">Death Profet</option>
    ...
    <option value="Keeper ofthe Light">Keeper ofthe Light</option>
    ...
    <option value="Morpling">Morpling</option>
    ...
    <option value="Shadwo Shaman">Shadwo Shaman</option>
